...
Este repositório contém o projeto "_Color Guess_", requisito em atendimento ao módulo de Fundamentos - JavaScript: DOM, Eventos e Web Storage, da Trybe. O projeto consiste em uma aplicação que deverá ser possível jogar um jogo de adivinhação de cores e sua pontuação deverá atualizar de acordo com os acertos.
